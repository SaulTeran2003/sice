...
<table class="table table-success table-striped">
            ...
            <tr>
              ...
              <td>
                  <?php
                      if (!empty($row['FUP'])) {
                          // Si hay un valor en FUP, mostrar un enlace o icono para abrir el PDF
                          echo '<a href="../' . $row['FUP'] . '" target="_blank"><i class="fas fa-file-pdf"></i></a>';
                      } else {
                          // Si no hay valor en FUP, mostrar un mensaje o dejar en blanco
                          echo 'Sin PDF';
                      }
                  ?>
              </td>
