...
<head>
  ...
  <title>SICE | Iniciar Sesión</title>
  <link rel="icon" href="img/SICEICO2.ico" type="image/x-icon">
  ...
  <!-- ////////////////TARJETA DE INICIO DE SESIÓN /////////////////////-->
    ...
    <div class="card border-0 shadow-lg login-card">
      <div class="card-body p-5 bg-white">
        ...
        <!-- Logotipo SICE QUE ESTA DENTRO DE LA TARJETA DE INICIO DE SESIÓN-->
        <div class="mb-4">
...
<?php include_once './partials/footer_ipn.php'; ?>
 ...
 <!-- AQUÍ SE ENCONTRARA EL APARTADO DE LA INFORMACIÓN DEL BODY EL CUAL ES DE 
