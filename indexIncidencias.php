...
<head>
  ...
  <title>SICAH | Menu Incidencias</title>
...
<div class="row justify-content-around align-items-start vh-60">
  <div class="card" style="width: 18rem; height: 410px" align="center">
    ...
    <div class="card-body">
      ...
      <a href="/sicah-web/IncidenciasAutocompletar.php" class="btn btn-primary">Agregar</a>
    </div>
  </div>
  <div class="card" style="width: 18rem; height: 410px" align="center">
  <img src="img/Logo Sicah.png" class="card-img-top" style="width: 400; height: 200px;"/>
    <div class="card-body">
      ...
      <a href="/sicah-web/incidenciasDocentes.php" class="btn btn-primary">Consultar</a>
    </div>
  </div>
</div>
<br><br>
